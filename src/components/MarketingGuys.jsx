...
import pd from '../assets/dhaaba.png';
   ...
   <div className='d-content w-[95vw] sm:w-[1200px] mx-auto'>
      ...
      <div className='sm:flex gap-5 block  p-3 '>
          ...
          <div className='  grid place-items-center [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]  [border:1px_solid_rgba(255,255,255,0.1)] p-5 rounded-xl '>
              ...
              <div style={{ backgroundImage: `url(${p4})` }} className='bg-cover bg-center w-[100px] h-[100px] rounded-full bg-gray-400  [border:1px_solid_rgba(255,255,255,.1)] ' >
          ...
          <div className='  grid place-items-center [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]  [border:1px_solid_rgba(255,255,255,0.1)] p-5 rounded-xl '>
              ...
              <div style={{ backgroundImage: `url(${pd})` }} className='bg-cover bg-center w-[100px] h-[100px] rounded-full bg-gray-400  [border:1px_solid_rgba(255,255,255,.1)] ' >
