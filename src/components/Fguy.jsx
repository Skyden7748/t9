                   ...
                   <div className='profile-content   w-[100vw]  sm:w-[1344px] mx-auto  '>
                       <div className='sm:w-[85%] w-[95%]  mx-auto p-2 sm:p-5 rounded-tl-xl rounded-tr-xl  '>
                           ...
                           <div className='profile-name  self-center ml-5 '>
                              ...
                              <p className='text-neutral-400'>{t('portfolio52')} </p>
                           </div>
                           </div>
                       ...
                       <div className='profile-about w-[100%] sm:w-[85%] mx-auto [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] [border:1px_solid_rgba(255,255,255,.1)] rounded-xl p-10  ' >
                        ...
                        <p className='text-neutral-400 [font-size:1.1rem mb-[3px] ]' >{t('portfolio53')}</p> 
                        <p className='text-neutral-400 [font-size:1.1rem mb-[3px] ]' >{t('portfolio54')}</p>
                        <p className='text-neutral-400 [font-size:1.1rem mb-[3px] ]' >{t('portfolio55')}</p>
                        <p className='text-neutral-400 [font-size:1.1rem mb-[3px] ]' >{t('portfolio56')}</p>
                      ...
                      <div className=' progress w-[100%] sm:w-[85%] mx-auto  p-5 ' >
                                                                                ...
                                                                                <div className='md:flex w-[100%] pt-2 justify-between gap-3  '  >
                                                                                        <div className='md:w-[60%] w-[100%] p-2 sm:p-5   [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] [border:1px_solid_rgba(255,255,255,.1)] p-5 rounded-lg  '  >
                                                                                              ...
                                                                                              <div className='mt-4'>
                                                                                                 <h2 className='text-lg font-semibold text-neutral-300   '  >{t('stats8')}  <span className='font-[100]'>|</span> 90%</h2>
                                                                                                 <div className='flex '>
                       ...
                       <div className='profile-work w:[100%] sm:w-[75%] mx-auto [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] [border:1px_solid_rgba(255,255,255,.1)] rounded-t-xl   p-5 '>
                                                                                       ...
                                                                                       [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] [border:1px_solid_rgba(255,255,255,.1)]' ></div> <div><h1 className='text-[1rem] font-semibold text-neutral-200'>NEOMA Business School</h1> <p className='text-neutral-400 [font-size:1.1rem] md:[font-size:0.9vw] mt-2 ' > {t('portfolio60')} </p>
                      ...
                      Wellers Impact</h1> <p className='text-neutral-400 [font-size:1.1rem] md:[font-size:0.9vw] mt-2  ' > {t('portfolio61')} </p>
                                                                                       ...
                                                                                       [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] [border:1px_solid_rgba(255,255,255,.1)]' ></div> <div><h1 className='text-[1rem] font-semibold text-neutral-200'>IIRWM</h1> <p className='text-neutral-400 [font-size:1.1rem] md:[font-size:0.9vw] mt-2 ' >{t('portfolio62')}  </p>
